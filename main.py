...
alp = Image.open("alarm.png")
resized_image = alp.resize((220,220),Image.ANTIALIAS)
new_image =ImageTk.PhotoImage(resized_image)
img = Label(panel,image=new_image)
...
hr = Entry(panel,font=('comic sans',18),width=5)
...
amsg = Entry(panel,font=('comic sans',18),width=25)
